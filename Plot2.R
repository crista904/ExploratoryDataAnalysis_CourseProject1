##  Overview of steps to make Plot 2
##  Step 1: Import data
##  Step 2: Ensure data is formatted correctly and columns are labelled
##  Step 3: Subset data
##  Step 4: Plot line plot and save as a PNG file
...
plot2 <- plot(EPC_Subset$DateTime, EPC_Subset$Global_active_power, type = "l", ylab = "Global Active Power (kilowatts)", xlab = " ")
dev.off()
